//
//  UIControl+GSEventInterval.m
//  GSEngineeringBaseFramework
//
//  Created by 关宇琼 on 16/5/29.
//  Copyright © 2016年 GuanSir. All rights reserved.
//

#import "UIControl+GSEventInterval.h"
...
@implementation UIControl (GSEventInterval)
...
- (void)mySendAction:(SEL)action to:(id)target forEvent:(UIEvent *)event
{
    if ([NSStringFromClass(self.class) isEqualToString:@"UIButton"]) {
        ...
        self.timeInterval = self.timeInterval == 0 ? gs_Time_Interval : self.timeInterval;
