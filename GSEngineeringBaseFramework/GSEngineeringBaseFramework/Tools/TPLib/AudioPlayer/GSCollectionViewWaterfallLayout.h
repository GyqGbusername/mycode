 ...
 */
typedef NS_ENUM (NSUInteger, GSCollectionViewWaterfallLayoutItemRenderDirection) {
  GSCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst,
  GSCollectionViewWaterfallLayoutItemRenderDirectionLeftToRight,
  GSCollectionViewWaterfallLayoutItemRenderDirectionRightToLeft
};
...
extern NSString *const GSCollectionElementKindSectionHeader;
/// A supplementary view that identifies the footer for a given section.
extern NSString *const GSCollectionElementKindSectionFooter;

#pragma mark - GSCollectionViewDelegateWaterfallLayout

@class GSCollectionViewWaterfallLayout;

/**
 *  The GSCollectionViewDelegateWaterfallLayout protocol defines methods that let you coordinate with a
 *  GSCollectionViewWaterfallLayout object to implement a waterfall-based layout.
 ...
 */
@protocol GSCollectionViewDelegateWaterfallLayout <UICollectionViewDelegate>
...
#pragma mark - GSCollectionViewWaterfallLayout

/**
 *  The GSCollectionViewWaterfallLayout class is a concrete layout object that organizes items into waterfall-based grids
 ...
 *  in each section. That delegate object must conform to the `GSCollectionViewDelegateWaterfallLayout` protocol.
 *
 ...
 *
 *  @note GSCollectionViewWaterfallLayout doesn't support decoration view, and it supports vertical scrolling direction only.
 */
@interface GSCollectionViewWaterfallLayout : UICollectionViewLayout
 ...
 *  @discussion
 *    The direction in which each item is rendered. This could be left to right (GSCollectionViewWaterfallLayoutItemRenderDirectionLeftToRight), right to left (GSCollectionViewWaterfallLayoutItemRenderDirectionRightToLeft), or shortest column fills first (GSCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst).
 *
 *    Default: GSCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst
 */
@property (nonatomic, assign) GSCollectionViewWaterfallLayoutItemRenderDirection itemRenderDirection;
