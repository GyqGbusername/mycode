 ...
 *  获取主线程
 */
#define gs_MainQueue [NSOperationQueue mainQueue]
...
#define gs_GuideViewController [GSGuideViewController sharedGuide]
...
#define gs_LoadUrl(urlStr)   [NSURL URLWithString:urlStr];

/**
 *  URL返回Request
 */

#define gs_LoadRequest(urlStr)  [NSURLRequest requestWithURL:[NSURL URLWithString:urlStr]]
...
#define EGOCache_CurrentCache     [EGOCache currentCache]
#define EGOCache_GlobalCache       [EGOCache globalCache]
